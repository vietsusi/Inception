...
alias chrome='flatpak run com.google.Chrome --host-resolver-rules="MAP vinguyen.42.fr 192.168.56.101" --user-data-dir=/tmp/eval_profile --ignore-certificate-errors --ignore-ssl-errors --allow-insecure-localhost'
